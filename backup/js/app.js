...
function getHomeHTML(params) {
  ...
  return `
    ...
    <section class="hero-section">
      ...
      <div class="hero-section__visual">
        <div class="hero-illustration-container">
          <!-- Soft premium gradient glows behind the illustration -->
          <div class="hero-shape hero-shape--gradient-circle-pink"></div>
          <div class="hero-shape hero-shape--gradient-circle-blue"></div>
          
          <!-- Confident business man holding smartphone showing logo (transparent composition PNG) -->
          <img src="assets/media__1781084322621.png" alt="TechnoStore360 Hero Visual" class="hero-illustration-img">
        </div>
      </div>
    </section>
        ...
        <div class="marquee-track">
          <div class="marquee-content">
            ...
            <div class="trust-logo">
              ...
              <span class="trust-logo-text" style="color: #4f5b70; font-weight: 600; font-family: 'Segoe UI', sans-serif; font-size: 0.95rem;">Microsoft</span>
            </div>
            ...
            <div class="trust-logo">
              ...
              <span class="trust-logo-text" style="color: #4f5b70; font-weight: 600; font-family: 'Segoe UI', sans-serif; font-size: 0.9rem;">Google Cloud</span>
            </div>
            ...
            <div class="trust-logo">
              ...
              <span class="trust-logo-text" style="color: #2c2c2c; font-weight: 800; font-family: 'Clean', sans-serif; font-size: 0.95rem;">Adobe</span>
            </div>
          </div>
    ...
    <section style="margin-top: 2rem;">
      ...
      <div id="home-trending-grid" class="product-grid" style="grid-template-columns: repeat(4, 1fr);"></div>
    </section>
    ...
    <section class="ai-banner-section">
      <div>
        <span class="section-kicker">AI-POWERED SOLUTIONS</span>
        <h2>AI-Powered Solutions for a Smarter Tomorrow</h2>
        <p>Discover next-generation intelligent solutions designed to automate, analyze, and accelerate your business growth.</p>
        
        <div class="ai-banner-features">
          <div class="ai-feature-item">
            <i data-lucide="check-circle"></i> AI Chatbots & Virtual Assistants
          </div>
          <div class="ai-feature-item">
            <i data-lucide="check-circle"></i> Intelligent Document Processing
          </div>
          <div class="ai-feature-item">
            <i data-lucide="check-circle"></i> Predictive Analytics & Insights
          </div>
          <div class="ai-feature-item">
            <i data-lucide="check-circle"></i> Workflow Automation
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: flex; gap: 0.75rem; margin-bottom: 1rem;">
            <div style="flex: 1; position: relative; display: flex; align-items: center;">
              ...
              <input type="text" id="listing-search-box" value="${appState.filters.search}" placeholder="Search products, brands, services..." style="width: 100%; padding: 0.65rem 1rem 0.65rem 2.5rem; border: 1px solid var(--slate-200); border-radius: var(--radius-md); outline: none; background-color: var(--white); font-size: 0.85rem;">
            </div>
            <button class="btn btn-outline btn-sm" id="mobile-filter-drawer-btn" style="display: none;"><i data-lucide="filter"></i> Filters</button>
          </div>
          ...
          <div id="listing-results-grid" class="product-grid" style="grid-template-columns: repeat(3, 1fr);">
...
function getDemoHTML(params) {
  ...
  return `
    <div style="padding-top: 0.5rem;">
      <div style="display: grid; grid-template-columns: 1.25fr 1fr; gap: 2rem; align-items: start;">
...
function getAdminHTML(activeTab) {
  ...
  if (activeTab === 'dashboard') {
    panelContentHTML = `
      <div class="dash-stat-grid" style="grid-template-columns: repeat(3, 1fr); margin-bottom: 1.5rem;">
        <div class="dash-stat-card" style="border-radius: var(--radius-lg);">
  ...
  return `
    <div class="dashboard-layout" style="grid-template-columns: 200px 1fr; gap: 1.5rem; min-height: auto;">
